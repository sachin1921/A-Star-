'''
   Some starter code for your A* search through Dubrovnik
   Z. Butler, 3/2015
'''
# for GUI things
from tkinter import *
...
# meters per degree longitude at 42N
...
class MyWin(Frame):
    ...
    def mapclick(self, event):
        ...
        '''
        self.canvas.coords('greendot', event.x-5,
                           event.y-5, event.x+5, event.y+5)
